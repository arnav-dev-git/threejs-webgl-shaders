var ShaderFrogRuntime = (function (e) {
  ...
  function (e, r, a) {
    ...
    function i() {
      ...
      for (var a = 1; e > a; a++)
        for (
          var t = arguments[a], n = Object.keys(t || {}), i = n.length, s = 0;
          i > s;
          s++
        ) {
          var o = n[s];
    ...
    (n.prototype = {
      ...
      updateSource: function (e, r, a) {
        if (((a = a || "name"), !this.shaderTypes[e]))
          throw new Error(
            "Runtime Error: Cannot update shader " +
              e +
        ...
        var t = this.add(e, r),
          n = void 0,
          s = void 0;
        for (s = 0; (n = this.runningShaders[s++]); )
          n[a] === e &&
            (i(n.material, o(t, "id")), (n.material.needsUpdate = !0));
      },
      renameShader: function (e, r) {
        ...
        if (!(e in this.shaderTypes))
          throw new Error(
            "Could not rename shader " + e + " to " + r + ". It does not exist."
          );
        for (
          this.shaderTypes[r] = this.shaderTypes[e],
            delete this.shaderTypes[e],
            a = 0;
          (t = this.runningShaders[a++]);
      ...
      add: function (e, r) {
        var a = s(r),
          t = void 0;
        (a.fragmentShader = r.fragment),
          (a.vertexShader = r.vertex),
          delete a.fragment,
          delete a.vertex;
        for (var n in a.uniforms)
          (t = a.uniforms[n]),
            null === t.value &&
              (a.uniforms[n].value = this.getUmap(t.glslType));
        return (
          e in this.shaderTypes
            ? i(this.shaderTypes[e], a)
            : (this.shaderTypes[e] = a),
          a
        );
      },
      create: function (e) {
        var r = this.shaderTypes[e];
        return (
          (r.material = new d.RawShaderMaterial(r)),
          this.runningShaders.push(r),
          r.init && r.init(r.material),
      ...
      updateRuntime: function (e, r, a) {
        ...
        for (n = 0; (t = this.runningShaders[n++]); )
          if (t[a] === e)
            for (i in r.uniforms)
              i in this.reserved ||
                (i in t.material.uniforms &&
                  ((s = r.uniforms[i]),
                  "t" === s.type &&
                    "string" == typeof s.value &&
                    (s.value = this.cubeCameras[s.value].renderTarget),
                  (t.material.uniforms[i].value = r.uniforms[i].value)));
      },
      updateShaders: function (e, r) {
        ...
        for (r = r || {}, t = 0; (a = this.runningShaders[t++]); ) {
          for (var n in r.uniforms)
            n in a.material.uniforms &&
              (a.material.uniforms[n].value = r.uniforms[n]);
          "cameraPosition" in a.material.uniforms &&
            this.mainCamera &&
            (a.material.uniforms.cameraPosition.value =
              this.mainCamera.position.clone()),
            "viewMatrix" in a.material.uniforms &&
              this.mainCamera &&
              (a.material.uniforms.viewMatrix.value =
                this.mainCamera.matrixWorldInverse),
            "time" in a.material.uniforms &&
              (a.material.uniforms.time.value = e);
        }
      },
      shaderTypes: {},
      runningShaders: [],
