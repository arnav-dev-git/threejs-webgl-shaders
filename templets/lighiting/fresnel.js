...
void main()
{
  ...
  vec3 color2 = vec3(abs(vPosition.x), abs(vPosition.y), abs(vPosition.z));
...
const geometry = new THREE.TorusKnotGeometry(1, 0.5, 240, 64);
...
function rotation(mesh, x = 0.05, y = 0.03, z = 0.02) {
  mesh.rotation.x += x;
  mesh.rotation.y += y;
  mesh.rotation.z += z;
}
